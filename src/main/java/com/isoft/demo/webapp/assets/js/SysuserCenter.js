...
$(function(){
    ...
    $("#repassBtn").click(function(){
        var info = {id : userObj.id, newpass : $('#repassForm input[name = "newPass"]').val(), oldpass : $('#repassForm input[name = "oldPass"]').val()}
            $.ajax({
                type : 'PUT',
                // type : 'POST',
                // url : testRepassUrl,
    ...
    oFileInput.Init("userphoto", sysUserPhoto + "?id=" + userObj.id,);
